              ...
              return (
                <ScrollReveal key={category._id} delay={index * 0.1} direction="up">
                  <Link href={`/products?category=${category.slug}`}>
                    <Card
                      className="group relative flex min-h-50 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-surface border border-line bg-panel p-6 text-center transition-[border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-electric/40 hover:shadow-soft sm:min-h-60 sm:p-8"
                    >
